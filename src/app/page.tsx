...
import { Users, FileSpreadsheet, ArrowRight, Shield } from "lucide-react";
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Consulte usuários no diretório LDAP de forma individual ou em lote
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto mb-16">
          ...
          <Card className="group hover:shadow-xl transition-all duration-300 border-0 shadow-lg bg-white/80 backdrop-blur-sm">
            <CardHeader className="text-center pb-4">
              ...
              <CardDescription className="text-gray-600 text-base">
                Faça upload de um arquivo CSV com múltiplos usuários para
